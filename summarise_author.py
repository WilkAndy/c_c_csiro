...
def get_themes(abstracts: list, verbose: bool) -> str:
   ...
   if OpenAI(model_name = 'text-davinci-003').modelname_to_contextsize('text-davinci-003') > docs_num_tokens + 400:
      ...
      prompt_template = """In 200-300 words, describe the scientific themes in the following text:
      {text}
      ...
      SUMMARY:"""
      combine_prompt_template = """In 200-300 words, describe the scientific themes in the following text:
      {text}
